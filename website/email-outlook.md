...
# Optional — the tenant sign-in goes through. A tenant GUID or verified
# domain for single-tenant apps, `organizations` for any work/school
# account, or `consumers` for personal accounts. Defaults to `common`.
